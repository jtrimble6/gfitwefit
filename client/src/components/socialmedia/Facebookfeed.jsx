    ...
    return (
      <div className='facebookFeed' style={this.props.style}>
        <Slider {...settings}>
          ...
          <div>
            <iframe title='fb8' src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fpenny.moore.7399%2Fposts%2F10156035049449635&width=350&show_text=true&height=251&appId" width="350" height="251" style={fbFeedStyle} scrolling="no"  frameBorder="0"   allow="encrypted-media"></iframe>
          </div>
          <div>
            <iframe title='fb9' src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FSkyeHGraham%2Fposts%2F10215063733014481%3A0&width=350&show_text=true&height=311&appId" width="350" height="311" style={fbFeedStyle} scrolling="no"  frameBorder="0"   allow="encrypted-media"></iframe>
          </div>
        </Slider>
      </div>
    );
